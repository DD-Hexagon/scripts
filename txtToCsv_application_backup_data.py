...
def process_json_to_csv(json_file, csv_file, org_mapping):
    ...
    with open(csv_file, 'w', newline='', encoding='utf-8') as csvfile:
        ...
        for item in app_data:
            ...
            # Concatenate all tenant IDs into a single string, ensuring they're valid strings
            tenants = ','.join(str(tenant) for tenant in item.get("TenantIds", []) if tenant)
            ...
            csv_row = {
                ...
                "Group": groups,
                "Tenant": tenants,  # Include all tenants in the same column
